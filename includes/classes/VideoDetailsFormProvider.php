...
class VideoDetailsFormProvider {
    ...
    private function createFileInput() {
        return "<div class='form-group'>
                    <label for=''>Your filet</label>
                    <input type='file' class='form-control-file' id='' name='fileInput' required>
                </div>";
    }
    ...
    private function createSaveButton() {
        return "<button type='submit' class='btn btn-primary' name='saveButton'>Upload</button>";
    }
}
?>