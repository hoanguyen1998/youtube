...
class VideoProcessor {
    ...
    private $con; 
    private $sizeLimit = 500000000; // 500.000.000 bytes
    private $allowedTypes = array("mp4", "flv", "webm", "mkv", "vob", "obv", "ogg", "avi", "wmv", "mov", "mpeg", "mpg");
    private $ffmpegPath = "ffmpeg/bin/ffmpeg";
    private $ffprobePath = "ffmpeg/bin/ffprobe"; 

    public function __construct($con) {
        $this->con = $con;
        //$this->ffmpegPath = realpath("ffmpeg/bin/ffmpeg"); in window add .exe
    }
    ...
    private function isValidType($type) {
        $lowercased = strtolower($type); // prevent MP4, FLV
